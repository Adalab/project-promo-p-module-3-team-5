    ...
    <>
      ...
      <section className="box-preview">
              ...
              <section className="containercard">
                ...
                <ul className="preview-list">
                  <li className="preview-list__item js-preview-list border">
                    <a className="preview-list__item--link" href="">
        ...
        <section className="section-form">
          <form action="">
            <fieldset className="fieldset collapsed js-form-fieldset fieldset-colours">
            ...
            <fieldset className="fieldset collapsed js-form-fieldset fill__fieldset">
            ...
            <fieldset className="fieldset collapsed js-form-fieldset share__fieldset">
